...
<?php include('includes/header.php');?>
			...
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="dashboard.php">Home</a><i
					class="fa fa-angle-right"></i>Add Book</li>
			</ol>
			<!--grid-->
			<div class="grid-form">
							...
							<form class="form-horizontal" name="book" method="post"
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="booktype"
											id="booktype" placeholder=" Book Type" required>
									</div>
								</div>
								...
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Book
										Price in INR</label>
									<div class="col-sm-8">
										<input type="number" min="1" class="form-control1" name="bookprice"
											id="bookprice" placeholder=" Book Price is INR" required>
									</div>
								</div>
								...
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Book
										Author</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="bookauthor"
											id="bookauthor" placeholder="Book Author" required>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="number" min="1" class="form-control1" name="quantity"
											id="quantity" placeholder="Book Quantity" required>
									</div>
								</div>
